...
void setup() {
  ...
  if (adjust_temp == true) {
    ...
    dir = true;
    current_steps = 0;
    steps_needed = (4076 * 5.5); //adjust to point position of 45 degrees to closed
    while (current_steps <= steps_needed) {
      stepperMotorFunction();
    }
    delay(500);
  ...
  if (adjust_bright == true) {
    ...
    dir = true;
    steps_needed = (4076 * 3.8) + (5 - bright_scale) * (4076 * 0.9);
    while (current_steps <= steps_needed) {
      stepperMotorFunction();
    }
...
void loop() {
  while (adjust_temp == true) {
    ...
    delay(2000);
    if ((temperatureF <= ideal_temp + 1) && (temperatureF >= ideal_temp - 1) && (adjustment_made_ccw == false) && (adjustment_made_cw == false)) { //temperature is within a 1 degree range, no movement necessary
      ...
      if ((temperatureF >= ideal_temp + 1) && adjustment_made_ccw == false && adjustment_made_cw == true) {
        dir = true;
        current_steps = 0;
        steps_needed = 4076 * 4;
        while (current_steps <= steps_needed) {
      ...
      if ((temperatureF <= ideal_temp - 1) && (adjustment_made_ccw == true && adjustment_made_cw == false)) {
        dir = false;
        current_steps = 0;
        steps_needed = 4076 * 4;
        while (current_steps <= steps_needed) {
  ...
  while (adjust_bright == true) {
    ...
    if (isClosedDarkness == false && isDark == true) {
      ...
      dir = true;
      steps_needed = (current_position) * (4076 * 0.75);
      current_steps = 0;
      while (current_steps <= steps_needed) {
        stepperMotorFunction();
      }
